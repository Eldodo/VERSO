...
public class ParserAppli implements IApplication{
	...
	public Object start(IApplicationContext iac)
	{
        ...
        "application.args");
		*/
		String projectName = "PinBoard";
		//creating the model from the AST
		System.out.println("ici :"+SystemManager.getSystem(projectName));
		buildModel(projectName);
		//computing Metrics
		new File("C:\\Users\\Dorian\\Documents\\master\\verso\\verso\\data\\Data_VERSO_HEB\\"+projectName+"\\").mkdir();
		CsvWriter cw = new CsvWriter(SystemManager.getSystem(projectName),"C:\\Users\\Dorian\\Documents\\master\\verso\\verso\\data\\Data_VERSO_HEB\\"+projectName+"\\"+projectName+".verso");
		cw.print();
		return EXIT_OK;
	}
