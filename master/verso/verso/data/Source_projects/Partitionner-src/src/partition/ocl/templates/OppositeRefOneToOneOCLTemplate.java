...
public class OppositeRefOneToOneOCLTemplate extends OCLTemplate {
	public final static Logger LOGGER = Logger.getLogger(OppositeRefOneToOneOCLTemplate.class.getName());
	...
	private OCLMatch buildOCLMatch(EClass clA, EClass clB,  EStructuralFeature bsRef, EStructuralFeature asRef) {
		...
		String expr = "self."+bs+"."+as+" = self";
		
		OCLMatch res = new OCLMatch("context "+classA+" inv OppositeRefOneToOne: ", expr, clA);
	...
	public String toString() {
		return "OppositeRefOneToOneOCLTemplate";
	}
}
