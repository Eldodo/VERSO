...
public class PlotGraphPanel extends JPanel {
	private static final long serialVersionUID = 5433389647057275171L;
	...
	class DataPanel implements ActionListener {
		...
		DataPanel(JFrame newFrame) {
			...
			paramFields[xLowerIndex] = new JTextField("0.0");
			paramFields[xUpperIndex] = new JTextField("1.0");
			paramFields[xIntervalIndex] = new JTextField(".1");
			paramFields[yLowerIndex] = new JTextField("0.0");
			paramFields[yUpperIndex] = new JTextField("1.0");
