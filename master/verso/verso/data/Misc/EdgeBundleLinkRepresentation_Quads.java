...
public class EdgeBundleLinkRepresentation extends LinkRepresentation implements Renderable {
	...
	*/
	...
	public void render(GL gl) {
		...
		Iterator<LinkedList<float[]>> renderingPointsItr = this.renderingPoints.iterator();
		
		LinkedList<float[]> currentRenderingPoints = renderingPointsItr.next();
		...
		*/
		...
		LinkedList<float[]> nextRenderingPoints;
			...
			while (renderingPointsItr.hasNext()) {
				...
				*/
				...
				for (int i = 0; i < currentRenderingPoints.size(); i++) {
					...
					float[] testVertex = currentRenderingPoints.get(i);
				...
				*/
				...
				for (int i = 0; i < currentRenderingPoints.size(); i++) {	
					...
					float[] previousNode = this.bSplinePoints.get(pointPos);
					float[] nextNode = this.bSplinePoints.get(pointPos+1);
