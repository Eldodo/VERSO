...
public class EdgeBundleLinkRepresentation extends LinkRepresentation implements Renderable {
	...
	private LinkedList<double[]> bSplinePoints;
	...
	*/
	...
	private HashMap<double[], Double> nodesEdgeLength = new HashMap<double[], Double>();
	...
	*/
	...
	private LinkedList<double[]> evaluateBSplinePoints(LinkedList<NodeRepresentation> controlPoints, LinkedList<Double> knotsPoints, int nbreSegments, int degree) {		
		LinkedList<double[]> bSplinePoints = new LinkedList<double[]>();
		...
		NodeRepresentation currControlPoint;
		double basisFunctionValue;
		double[] currControlPointPos = new double[3];
		double[] currSplinePoint;
	...
	private void evaluateNodesEdgeLength() {
		...
		Iterator<double[]> splinePointsItr = this.bSplinePoints.iterator();
		double[] previousNode = splinePointsItr.next();
		double[] currentNode;
	...
	private LinkedList<LinkedList<double[]>> evaluateRenderingPoints(LinkedList<double[]> bSplinePoints, int nbrePoints) {
		...
		Iterator<double[]> bSplinePointsItr = bSplinePoints.iterator();
		double[] previousNode = bSplinePointsItr.next();
		double[] currentNode = bSplinePointsItr.next();
			...
			while (renderingPointsItr.hasNext()) {
				...
				*/
				...
				for (int i = 0; i < currentRenderingPoints.size(); i++) {	
					...
					double[] previousNode = this.bSplinePoints.get(pointPos);
					double[] nextNode = this.bSplinePoints.get(pointPos+1);
