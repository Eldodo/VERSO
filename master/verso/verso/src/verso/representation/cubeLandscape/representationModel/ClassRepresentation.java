...
public class ClassRepresentation extends ElementRepresentation implements Renderable{
	...
	public ClassRepresentation(ClassDef c) {
		super(c);
		this.mesh = new Cube();
	...
	public String toString() {
		return "ClassRep<" + this.getElementModel().getName() + ">";
	}

	public String getName() {
		return "Class : " + this.getElementModel().getName();
	}
