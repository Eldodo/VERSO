...
import verso.reverse.main.GenerateUML;
import verso.reverse.main.ParseJava;
...
public class RunUMLParser {
	...
	public RunUMLParser(String input, String output){
		this.startProcess(input, output);
